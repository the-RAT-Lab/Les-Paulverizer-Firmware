...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"bordercolor" : [ 0.392156862745098, 0.996078431372549, 0.043137254901961, 1.0 ],
					"id" : "obj-44",
					"linecount" : 2,
					"maxclass" : "textedit",
					"numinlets" : 1,
					...
					"outlettype" : [ "", "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 45.0, 258.5, 269.0, 37.0 ],
					"text" : "websocket connection available at: http://10.0.1.2:8086"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 172.0, 188.0, 126.5, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 146.0, 194.5, 24.0, 24.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 307.0, 258.5, 192.0, 37.0 ],
...
,
					"patching_rect" : [ 45.0, 228.5, 120.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 131.25, 137.5, 156.0, 37.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 1,
					"patching_rect" : [ 45.0, 127.5, 91.0, 91.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
							"parameter_enum" : [ "off", "on" ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 307.0, 96.0, 216.615390062332153, 154.0 ],
					"tabname" : "Vyra"
				}
...
, 			{
		...
		"parameters" : 		{
			"obj-93" : [ "button[10]", "button[1]", 0 ],
			"obj-97" : [ "button[11]", "button", 0 ],
			"parameterbanks" : 			{
